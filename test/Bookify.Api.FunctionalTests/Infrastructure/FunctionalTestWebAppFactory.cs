...
public class FunctionalTestWebAppFactory : WebApplicationFactory<Program> , IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureTestServices(services =>
        {
            ...
            services
                .AddSingleton<ISqlConnectionFactory>(_ => new SqlConnectionFactory(_dbContainer.GetConnectionString()));
            //--
            services
                .Configure<RedisCacheOptions>(redisCacheOptions => 
            ...
            services.Configure<KeyCloakOptions>(o =>
            {
                ...
                o.AdminClientId = "bookify-admin-client";
                o.AdminClientSecret = "UZDmbNxWmV4TlpaCRcju6pMRsyuV3er1";
                o.AuthClientId = "bookify-auth-client";
                o.AuthClientSecret = "3E3yvXaYppoYBF3Ir6DgtEzADKKzSurZ";
            });
            //--
